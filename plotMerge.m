...
% units = {'002','002','002','002','002','002','002','002'};
% expts = {'000','001','002','004','005','006','013','014'};
% fileNum = [1 2 3 4 5 6 9 10];
% grp = [1 1 2 2 3 3 2 3];
% mergeID = '002000002001002002002004002005002006002010002011002013002014';
...
% expts = {'000','001','002','003'};
% fileNum = [1 2 3 4];
% grp = [1 1 2 3];
% mergeID = '000000000001000002000003';
...
fileNum = [1 2 3 4 5];
grp = [1 1 1 2 3];
mergeID = '000000000001000002000003000004';


% animal = 'febk7'; % NOT a great experiment for tracking neurons
% units = {'000','000','000','000','000','000','000'};
% expts = {'001','002','003','004','006','007','008'};
% fileNum = [1 2 3 4 5 6 7];
% grp = [1 1 1 1 1 2 3];
% mergeID = '000001000002000003000004000006000007000008';
