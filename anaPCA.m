...
colorbar
xBox = [0 1 1 0]; xOrthOff = [(0.5:11.5) (12.5:15.5)]; xBox = repmat(xBox',1,length(xOrthOff))+xOrthOff;
yBox = [0 0 1 1]; yOrthOff = [(4.5:15.5) (0.5:3.5)]; yBox = repmat(yBox',1,length(yOrthOff))+yOrthOff;
